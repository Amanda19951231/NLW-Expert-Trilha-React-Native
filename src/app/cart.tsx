...
const PHONE_NUMBER = "5533984198044"
...
export default function Cart() {
    ...
    const total = FormatCurrency(cartStore.products.reduce((aculmulator, currentValue) => aculmulator + currentValue.price * currentValue.quantity, 0))
    ...
    return (
        <View className="flex-1 pt-8">
            ...
            <View className="p-5 g-5">
                ...
                <LinkButton className="pt-5" title="Voltar ao cardápio" href="/"/>
            </View>
        </View>
    )
}